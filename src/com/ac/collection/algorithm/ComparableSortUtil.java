...
public class ComparableSortUtil {
    ...
    public static <T extends Comparable<T>> void mergeSort(T[] arr,T[] tempArr,int left,int right){
        if(left < right){
     ...
     */
    public static <T extends Comparable<T>>  void merge(T[] arr,T[] tempArr,int leftPos,int rightPos,int rightEnd){
        // 左边数组的结束下标
