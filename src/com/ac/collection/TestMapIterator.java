...
public class TestMapIterator {
    public static void main(String[] args) {
        ...
        // 1. 将这个 Map 的 key 转成 Set 集合
        // Map 的第一种遍历方式：遍历一个 Map 的所有的 key
        Set<String> keySet = coursesMap.keySet();
        ...
        // 2. 将这个 Map 中的所有的 value 转成集合
        // Map 的第二种遍历方式：遍历一个 Map 中所有的 value
        Collection<Course> courses = coursesMap.values();
        ...
        // 3. Map 的第三种遍历方式：遍历一个 Map 中的所有键值对
        Set<Map.Entry<String,Course>> entrySet = coursesMap.entrySet();
        for(Map.Entry<String,Course> entry: entrySet){
            // 每次一起访问 key-value 键值对
